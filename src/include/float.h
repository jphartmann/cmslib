...
/* Do not depend on hexadecimal float                                */
#define FLT_MAX 3.4e38
#define DBL_MAX 1.8e308
#define LDBL_MAX 1.2e4932

#define FLT_MIN 1.2e-45
#define DBL_MIN 4.9e-324
#define LDBL_MIN 6.5e-4966
